...
\author{Your Name \\ California State University, Los Angeles}
\date{\today}
...
1.0 & Snapshot 1 & Initial draft of SDD: architecture, basic UI description & Your Name \\ \hline
1.1 & Snapshot 2 & Added design for large feature \emph{Conversation History and Export} & Your Name \\ \hline
1.2 & Snapshot 3 & Added design for \emph{Multi-Channel Support} and refined data model & Your Name \\ \hline
1.3 & Snapshot 4 & Final polishing, added future work and updated workflow & Your Name \\ \hline
\end{longtable}
